	...
	try {
            ...
            for (let num of participants) {
                ...
                try {
                    ...
                    pp_user = 'https://telegra.ph/file/09e34505d9aa44e55b26b.jpg'
                }

                try {
                    ppgroup = await juna.profilePictureUrl(anu.id, 'image')
                } catch {
                    ppgroup = 'https://telegra.ph/file/09e34505d9aa44e55b26b.jpg'
                }
                if (anu.action == 'add' && (iswel || setting.auto_welcomeMsg)) {
                	console.log(anu)
                	        let ppusr = await await juna.profilePictureUrl(num, 'image').catch(_ => 'https://telegra.ph/file/09e34505d9aa44e55b26b.jpg')
        const canvafy = require('canvafy')
const well = await new canvafy.WelcomeLeave()
  . setAvatar(ppusr)
  .setBackground("image", 'https://telegra.ph/file/09e34505d9aa44e55b26b.jpg')
